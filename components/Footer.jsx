        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-links">
              ...
              <Link href="/visas" className="footer-link">
                Visas
              </Link>
              ...
              <Link href="/forex" className="footer-link">
                Forex
              </Link>

              <Link href="/air-tickets" className="footer-link">
                Air Tickets
              </Link>
          ...
          <div>
            ...
            <div className="footer-contact-info">
              ...
              <a
                href="mailto:info@visionvisa.in"
                className="footer-contact-item"
              >
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-socials">
            ...
            <a
              ...
              className="official-brand-logo-link"
